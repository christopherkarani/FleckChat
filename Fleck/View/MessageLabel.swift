...
open class MessageLabel: UILabel {
    ...
    // returns the given paragraph style for text
    ...
    private func detectorAttributes(for checkingResultType: NSTextCheckingResult.CheckingType) -> [NSAttributedStringKey: Any] {
        ...
        case .link:
            return urlAttributes
        default:
            fatalError(Error.unrecognizedCheckingResult)
        }
    }
    ...
    func handleGesture(_ touchLocation: CGPoint) {
    ...
    //Add Actions to NSTextCheckingKey types
